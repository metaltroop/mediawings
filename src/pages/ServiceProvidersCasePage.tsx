...
const ServiceProvidersCasePage = () => {
    const { openModal } = useModal();

    const caseStudies = [
        {
            company: "SERVICE PROS",
            title: "Scaling B2B Service Visibility",
            desc: "Helping professional service providers dominate their niche through authority-building content and laser-targeted lead generation.",
            image: "https://images.unsplash.com/photo-1454165833267-028ec2826603?auto=format&fit=crop&q=80&w=1200",
            link: "#"
        }
    ];
                ...
                <div className="max-w-[1440px] mx-auto px-4 md:px-8 text-center md:text-left">
                    ...
                    <div className="max-w-4xl">
                        <h1 className="text-5xl md:text-8xl font-black text-black mb-8 leading-tight uppercase tracking-tighter">
                            Professional <span className="text-black italic">Service Providers</span>
                        </h1>
                        <p className="text-gray-600 text-lg md:text-xl mb-10 leading-relaxed max-w-2xl">
                            We help agency, consulting, and B2B service brands scale through authority-led digital marketing and performance-driven growth.
                        </p>
                        <button 
                            onClick={openModal}
                        ...
                        >
                            Grow Your Agency <ArrowRight size={18} />
                        </button>
                    </div>
                </div>
            </section>
...
export default ServiceProvidersCasePage;
